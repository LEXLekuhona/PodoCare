...
- [x] **Бриф для юриста:** `docs/product/b2b-contract-brief-for-legal.md` v1.1 + пакет `docs/product/lawyer-handoff-package.md` (передать юристу, заполнить реквизиты Podocare).
...
- [ ] **152-ФЗ / ПДн:** политика конфиденциальности; согласие(я) на обработку; … — **пакет для юриста:** `docs/product/lawyer-handoff-package.md`, бриф `b2b-contract-brief-for-legal.md`.
